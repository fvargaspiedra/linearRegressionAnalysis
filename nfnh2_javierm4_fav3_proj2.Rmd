...
Estimating each predictor's contribution to the variance in the response provides with an explanation of the relationships between the observed attributes and the response. The bar chart below visualizes the correlation of each predictor and the resposne. 
